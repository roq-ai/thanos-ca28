...
function PostViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<PostInterface>(
    ...
    () =>
      getPostById(id, {
        relations: ['organization', 'social_media_account'],
      }),
  );
          ...
          <>
            <Stack direction="column" spacing={2} mb={4}>
              ...
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.scheduled_time as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
            ...
            <Box>
              ...
              {hasAccess('social_media_account', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/social-media-accounts/view/${data?.social_media_account?.id}`}>
                      {data?.social_media_account?.platform}
                    </Link>
                  </Text>
                </Flex>
              )}
