...
import { getSocialMediaAccountById } from 'apiSdk/social-media-accounts';
...
function SocialMediaAccountViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Social Media Account Detail View
          </Text>
          {hasAccess('social_media_account', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/social-media-accounts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('post', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/posts/create?social_media_account_id=${data?.id}`}>
